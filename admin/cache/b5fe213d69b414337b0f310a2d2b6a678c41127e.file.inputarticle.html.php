<?php /* Smarty version Smarty-3.1.15, created on 2014-12-09 22:39:07
         compiled from "view/inputarticle.html" */ ?>
<?php /*%%SmartyHeaderCode:117269012554479e8f681a05-54454630%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '117269012554479e8f681a05-54454630',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_54479e8f723635_66172628',
  'variables' => 
  array (
    'basedomain' => 0,
    'data' => 0,
...
<?php if ($_valid && !is_callable('content_54479e8f723635_66172628')) {function content_54479e8f723635_66172628($_smarty_tpl) {?><script>
$(function () {
	$('#postdate').datepicker ();
						...
						<div class="col-sm-12">
							...
							<label for="text-input">Kategori</label>
								<select class="form-control" name="articletype">
									<option value="1" <?php if ($_smarty_tpl->tpl_vars['data']->value['articleType']==1) {?>selected<?php }?>>Seleksi</option>
									<option value="2" <?php if ($_smarty_tpl->tpl_vars['data']->value['articleType']==2) {?>selected<?php }?>>Alumni</option>
									<option value="3" <?php if ($_smarty_tpl->tpl_vars['data']->value['articleType']==3) {?>selected<?php }?>>P3SWOT</option>
									<option value="4" <?php if ($_smarty_tpl->tpl_vars['data']->value['articleType']==4) {?>selected<?php }?>>Doms</option>
									<option value="5" <?php if ($_smarty_tpl->tpl_vars['data']->value['articleType']==5) {?>selected<?php }?>>Keuangan</option>
									<option value="6" <?php if ($_smarty_tpl->tpl_vars['data']->value['articleType']==6) {?>selected<?php }?>>Laporan</option>
									<option value="7" <?php if ($_smarty_tpl->tpl_vars['data']->value['articleType']==7) {?>selected<?php }?>>Disposisi</option>
								</select>
							</div>
						</div>	
						<div class="col-sm-12">
