...
class doms extends Controller {
	...
	public function index(){
		...
		$getTabelPendaftar = $this->contentHelper->getListTable('bu_doms',$db=4);
	...
	public function detail(){
		...
		$tb_name = _g('name');
		$getFieldPendaftar = $this->contentHelper->getListField(4, $tb_name);
